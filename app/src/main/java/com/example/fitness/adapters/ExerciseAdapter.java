...
public class ExerciseAdapter extends RecyclerView.Adapter<ExerciseAdapter.ExerciseViewHolder> {
    ...
    private List<Exercise> fitnessList = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull ExerciseViewHolder holder, int position) {
        ...
        Exercise localFitness = fitnessList.get(position);
    ...
    public void reload(int fitnessID) {
        fitnessList = SingleFitness.exerciseDatabase.exerciseDao().getAll(fitnessID);
